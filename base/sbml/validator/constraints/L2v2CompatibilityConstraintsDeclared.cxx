 ...
 *
 * @file    L2v2CompatibilityConstraintsDeclared.cxx
...
addConstraint(new VConstraintUnitDefinition93001(*this));

addConstraint(new VConstraintUnit93001(*this));

addConstraint(new VConstraintCompartmentType93001(*this));

addConstraint(new VConstraintSpeciesType93001(*this));

addConstraint(new VConstraintCompartment93001(*this));

addConstraint(new VConstraintSpecies93001(*this));

addConstraint(new VConstraintTrigger93001(*this));

addConstraint(new VConstraintDelay93001(*this));

addConstraint(new VConstraintUnit93002(*this));

addConstraint(new VConstraintKineticLaw93003(*this));

addConstraint(new VConstraintKineticLaw93004(*this));

addConstraint(new VConstraintEvent93005(*this));

addConstraint(new VConstraintModel93006(*this));

addConstraint(new DuplicateTopLevelAnnotation(93009, *this));

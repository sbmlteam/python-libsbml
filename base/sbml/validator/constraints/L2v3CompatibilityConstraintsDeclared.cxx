 ...
 *
 * @file    L2v3CompatibilityConstraintsDeclared.cxx
...
addConstraint(new VConstraintUnit94001(*this));

addConstraint(new VConstraintKineticLaw94002(*this));

addConstraint(new VConstraintKineticLaw94003(*this));

addConstraint(new VConstraintSpecies94004(*this));

addConstraint(new VConstraintEvent94005(*this));

addConstraint(new VConstraintEvent94006(*this));

addConstraint(new VConstraintModel94007(*this));

addConstraint(new DuplicateTopLevelAnnotation(94010, *this));

...
class SwigDirector_SBMLResolver : public SBMLResolver, public Swig::Director {

public:
    SwigDirector_SBMLResolver(PyObject *self);
    SwigDirector_SBMLResolver(PyObject *self, SBMLResolver const &c);
    virtual ~SwigDirector_SBMLResolver();
    virtual SBMLResolver *clone() const;
    virtual SBMLDocument *resolve(std::string const &uri, std::string const &baseUri = "") const;
    virtual SBMLUri *resolveUri(std::string const &uri, std::string const &baseUri = "") const;
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (!method) {
          std::string msg = "Method in class SBMLResolver doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
